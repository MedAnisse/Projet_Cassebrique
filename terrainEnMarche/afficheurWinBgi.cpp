...
void afficheurWinBgi::fermerFenetre()const
{
    ::closegraph();
}
void afficheurWinBgi::afficherTerrain(double largeur,double hauteur) const
{
     ::opengraphsize((int)largeur+8,(int)hauteur+10);
}
}
